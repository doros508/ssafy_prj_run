...
VALUES 
('user1', '123', 'user01@example.com', '채건우', '19900101', 'M', 'Seoul', 'Gangnam', 12345, '010-1234-5678', 30, 'johnny', 'path/to/photo.jpg', 'USER', 'some_iat', 'some_exp'),
('user2', '123', 'user02@example.com', '진종수', '19920304', 'F', 'Busan', 'Haeundae', 67890, '010-2345-6789', 28, 'janey', 'path/to/photo2.jpg', 'USER', 'some_iat', 'some_exp'),
('user3', '123', 'user02@example.com', '이동영', '19920304', 'F', 'Busan', 'Haeundae', 67890, '010-2345-6789', 28, 'janey', 'path/to/photo2.jpg', 'USER', 'some_iat', 'some_exp');
