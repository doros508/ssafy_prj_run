...
('초보자를 위한 달리기 가이드', '홍길동', '달리기를 처음 시작하는 사람들을 위한 기본적인 팁과 준비물을 설명합니다.', NOW(), 1, 150, 1, ''),
('마라톤 훈련 계획', '김철수', '마라톤을 준비하는 사람들을 위한 훈련 계획과 전략을 제공합니다.', NOW(), 2, 200, 2, ''),
('효과적인 러닝 자세', '이순신', '달리기 자세와 발 착지 기술을 개선하여 부상을 방지하는 방법에 대해 다룹니다.', NOW(), 3, 180, 3, ''),
('달리기 전 후 스트레칭', '박영희', '달리기 전후에 필요한 스트레칭 방법과 운동 후 회복을 돕는 팁을 소개합니다.', NOW(), 1, 220, 4, ''),
('다이어트를 위한 러닝', '최진호', '달리기를 통한 효과적인 체중 감량 방법과 운동 루틴을 제안합니다.', NOW(), 2, 250, 5, ''),
('달리기 속도 향상시키는 방법', '정은영', '달리기 속도를 개선하기 위한 훈련 방법과 테크닉을 설명합니다.', NOW(), 3, 130, 6, ''),
('겨울철 러닝 팁', '김지민', '겨울철 달리기를 위한 옷차림과 안전한 운동을 위한 팁을 제공합니다.', NOW(), 1, 160, 7, ''),
('러닝과 심박수', '박민수', '달리기 중 심박수를 관리하는 방법과 그 중요성에 대해 설명합니다.', NOW(), 2, 140, 8, ''),
('하프 마라톤 준비하기', '오세훈', '하프 마라톤을 준비하는 사람들을 위한 훈련법과 전략을 소개합니다.', NOW(), 3, 170, 9, ''),
('달리기와 정신 건강', '이하늘', '달리기가 정신 건강에 미치는 긍정적인 영향과 이를 통해 얻을 수 있는 장점에 대해 설명합니다.', NOW(), 1, 200, 10, '');
...
-- 대전 크루
(10, '갑천 러너스', 17, 4, 2, '갑천뛰는 대전 대표 러닝크루입니다.', 'https://open.kakao.com/o/gsF6WN1g', '월,수', 36.3654, 127.3645, '갑천 내부 (별도공지)'),
...
-- 서울 (city_no: 1)
('서울 마라톤 대회', '2024-11-03', '서울 잠실종합운동장', '풀코스, 하프코스, 10km', 'http://www.songparunsportal.com/', '2024-10-20', 1),
('한성백제마라톤대회', '2024-11-10', '서울 올림픽공원', '10km, 5km', 'https://www.songpa.go.kr/marathon', '2024-10-22', 1),
('서울시민 마라톤', '2024-11-17', '서울 여의도한강공원', '하프코스, 10km', 'https://www.seoul-citizen-marathon.com', '2024-10-25', 1),

-- 대전 (city_no: 2)
('대전 시민 마라톤', '2024-11-12', '대전 한밭종합운동장', '하프코스, 10km', 'https://www.daejeon-marathon.com', '2024-10-22', 2),
('대전 사이언스런', '2024-11-19', '대전 엑스포과학공원', '10km, 5km', 'https://www.science-run.kr', '2024-10-25', 2),
('대전 한밭수목원 마라톤', '2024-11-24', '대전 한밭수목원', '하프코스, 10km', 'https://www.hanbat-marathon.kr', '2024-10-28', 2),

-- 부산 (city_no: 3)
('부산 마라톤 대회', '2024-11-05', '부산 아시아드경기장', '풀코스, 10km', 'https://www.busan-marathon.com', '2024-10-20', 3),
('해운대 비치런', '2024-11-15', '부산 해운대해수욕장', '하프코스, 10km', 'https://www.haeundae-run.kr', '2024-10-23', 3),
('부산 광안리 마라톤', '2024-11-25', '부산 광안리해수욕장', '10km, 5km', 'https://www.gwangalli-marathon.kr', '2024-10-28', 3);


INSERT INTO `board` (`board_file_no`, `board_title`, `board_content`, `user_no`) VALUES
('file001', '공지사항', '그동안 다들 수고하셨습니다 있다가 재밌게 놀자', 1),
...
('file004', '대전 마라톤 참가 준비', '대전 마라톤 참가를 위한 체력 관리 및 훈련 방법을 공유합니다.', 3),
('file005', '강릉 마라톤 완주 성공!', '강릉 마라톤에서 처음으로 풀코스를 완주했습니다. 느낀 점을 나누고 싶어요.', 2),
('file006', '마라톤 초보자를 위한 준비물 리스트', '마라톤에 처음 참가하시는 분들을 위해 준비해야 할 필수 아이템 리스트를 작성했습니다.', 3),
('file007', '인천 마라톤 풍경 사진', '인천 마라톤에서 촬영한 멋진 풍경 사진을 공유합니다.', 2),
('file008', '춘천 호수 마라톤 경험담', '춘천 호수 마라톤에 참가하며 겪었던 일과 느낀 점을 나눕니다.', 2),
('file009', '전주 한옥길 마라톤 일정', '전주 한옥길 마라톤 일정과 참가 정보를 알려드립니다.', 3),
...
('admin', 'admin', 'user01@example.com', '관리자', 
